      ...
      <View style={styles.container}>
        ...
        <View style={styles.containerTopNavbar}>
          <View style={styles.topNavbar}>
            <Text style={styles.textTopNavbar}>Deals</Text>
            <Icons
              name="bell"
              size={22}
              color="white"
        ...
        <ScrollView>
          <View>
            ...
            <View style={styles.containerTopImage}>
              <Image source={Slider} style={styles.topImage} />
            </View>
            <View>
              <View style={styles.containerCard}>
                <View style={styles.card}>
                  <Text style={styles.textHeaderCard1}>
                ...
                <View style={styles.containerPromo}>
                  <Text style={styles.textPromo}>
                    Serbu Berbagai promo terbaru OWO
                  </Text>
                </View>
                ...
                <ScrollView horizontal={true} style={styles.scrollStyle}>
                  <View style={styles.containerCardImage}>
                    ...
                    <View style={styles.containerTextTitleCard}>
                      <Text style={styles.textTitleCardTop}>
                        Semua Menu Diskon 25%
                      </Text>
                      <Text style={styles.textTitleCardMiddle}>McDonald</Text>
                      <Text style={styles.textTitleCardCenter}>
                        Tersedia 7447 vouchera
                      </Text>
                  ...
                  <View style={styles.containerCardImage}>
                    ...
                    <View style={styles.containerTextTitleCard2}>
                      ...
                      <Text style={styles.textTitleCardBottom} />
                    </View>
                  </View>
                </ScrollView>
              </View>
              ...
              <View style={styles.containerCard2}>
                <View style={styles.card}>
                  <Text style={styles.textHeaderCard2}>
              ...
              <View style={styles.containerFooter}>
                <View style={styles.containerTextHeaderFooter}>
                  <Text style={styles.textTopFooter}>Nikmat Dunia Lainnya</Text>
                ...
                <View style={styles.containerFooterIcon}>
                  <View style={styles.footerIcon}>
                    <Icons name="spoon" size={30} color="orange" />
                    <Icons name="shopping-cart" size={30} color="red" />
                    <Icons name="bus" size={30} color="blue" />
                    <Icons name="graduation-cap" size={30} color="green" />
                  </View>
                ...
                <View style={styles.containerFooterIcon}>
                  <View style={styles.footerIcon}>
                    <Icons name="gift" size={30} color="red" />
                    <Icons name="suitcase" size={30} color="yellow" />
                    <Icons name="user-plus" size={30} color="blue" />
                    <Icons name="bullseye" size={30} color="violet" />
                  </View>
                  <View style={styles.containerTextFooter}>
                ...
                <View style={styles.containerFooterIcon}>
                  <View style={styles.footerIcon}>
                    <Icons name="shirtsinbulk" size={30} color="red" />
                    <Icons name="heartbeat" size={30} color="blue" />
                    <Icons name="eye" size={30} color="red" />
                    <Icons name="cogs" size={30} color="blue" />
                  </View>
                  <View style={styles.containerTextFooter}>
